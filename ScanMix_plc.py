...
parser.add_argument('--noise_mode',  required=True)
parser.add_argument('--lambda_u', default=25, type=float, help='weight for unsupervised loss')
parser.add_argument('--r', required=True, type=float, help='noise ratio')
...
meta_info['noise_file'] = '{}/{}-{}-{:.2f}.json'.format(p['noise_dir'], p['dataset'], args.noise_mode, args.r)
